...
#{
#    "gcp_project_name": "YOUR-PROJECT-NAME-HERE",
#    "gcp_landing_bucket": "YOUR-LANDING-BUCKET-NAME-HERE",
#    "gcp_backup_bucket": "YOUR-BACKUP-BUCKET-NAME-HERE"
#}

#Set variables from environment
PROJECT_ID = Variable.get("gcp_project_name")
LANDING_BUCKET = Variable.get("gcp_landing_bucket")
BACKUP_BUCKET = Variable.get("gcp_backup_bucket")

#Default Args defining dag behavior 
default_arguments = {
    "owner": "airflow",
...
with DAG(
    ...
    #Python operator to list objects on landing zone
    #it will push the results into airflow metadata database
    ...
    #Jinja: Templating language for python, which renders string templates
    #https://airflow.apache.org/docs/apache-airflow/1.10.1/tutorial.html#templating-with-jinja 
    #Marcos: https://airflow.apache.org/docs/apache-airflow/stable/macros-ref.html
